...
# One strategy x Cooperators and Defectors:

df_1x2_money_CD <- 
  bind_rows( ## CAREFUL! run_id duplicates in bind!
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+M", "param_1_sim_BC5_L1_121149.csv")), 
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+M", "param_2_sim_BC5_L2_121149.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+M", "param_3_sim_BC10_L1_121149.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+M", "param_4_sim_BC10_L2_121211.csv")),
    .id = "source_id") %>% 
  clean_names() %>% 
  as_tibble()  %>% 
   rename(
...
df_1x2_DR_CD <- 
  bind_rows( ## CAREFUL! run_id duplicates in bind!
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+DR", "param_1_sim_BC5_L1_120702.csv")), 
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+DR", "param_2_sim_BC5_L2_120702.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+DR", "param_3_sim_BC10_L1_120702.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+DR", "param_4_sim_BC10_L2_120731.csv")),
    .id = "source_id") %>% 
  clean_names() %>% 
  as_tibble()  %>% 
  rename(
...
df_1x2_IR_CD <- 
  bind_rows( ## CAREFUL! run_id duplicates in bind!
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+IR", "param_1_sim_BC5_L1_121019.csv")), 
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+IR", "param_2_sim_BC5_L2_121019.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+IR", "param_3_sim_BC10_L1_121019.csv")),
    read_csv(here("Test zone-C", "C+D+other_strategy", "C+D+IR", "param_4_sim_BC10_L2_121047.csv")),
    .id = "source_id") %>% 
  clean_names() %>% 
  as_tibble()  %>% 
  rename(
...
# 3.1 Plot cooperation rates and share of surviving strategies in time (1-to-2, one conditional strategy against Cooperators and Defectors)
