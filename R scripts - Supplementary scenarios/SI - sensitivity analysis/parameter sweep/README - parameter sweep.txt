Money as a mechanism of generalized reciprocity: R script for the reference simulation with 500 agents (sensitivity analysis, control and money scenarios).

The "R script - SI parameter sweep.R" file generates plots used in the SI (Figures S3, S4 and S5).

This script uses the same data files as the reference scenario, but presents a broader range of parameters than the main manuscript (see Simulated Data directory; files must be decompressed):
